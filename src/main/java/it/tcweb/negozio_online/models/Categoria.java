...
public class Categoria {
    ...
    @NotBlank(message = "Il nomedella categoria è obbligatorio")
    @Size(min = 2, max = 100)
    private String nome;

    @Size(max = 200, message = "La descrizione non può superare i 200")
    ...
    @OneToMany(mappedBy = "categoria") // Lazy significa pigro, i dati vengono caricati solo quando li chiediamo davvero
