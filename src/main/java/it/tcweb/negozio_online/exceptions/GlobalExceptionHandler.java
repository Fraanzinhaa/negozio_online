...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(Exception ex){
        ErrorResponse body = new ErrorResponse(500,"Errore interno del server");
    ...
    public ResponseEntity<Map<String, String>> handleValidation(MethodArgumentNotValidException ex){
        ...
        ex.getBindingResult() //getbindingresult contiene il risultato della validazione  -quando valid fallisce
                .getFieldErrors() //contiene la lista degli errori, uno per campo
                .forEach(err ->
                        errori.put(err.getField(),  //inseriamo nella nostra mapa ilnome del campo che ha dato errore
